...
public class WorldUtilityManager : MonoBehaviour
{
    ...
    {
        //Throwing Daggers, Small Items, etc.
        ...
        //Standard Weapons e.g. Longsword, Axe, Mace
        if (poiseDamage >= 30f)
        {
            damageIntensity = DamageIntensity.Medium;
        }

        //Great Weapons e.g. Claymores, Greataxes, Mauls
        if (poiseDamage >= 70f)
        {
            damageIntensity = DamageIntensity.Heavy;
        }

        //Ultra-sized Weapons e.g. Anime-scale Great Weapons
        if (poiseDamage >= 120f)
        {
